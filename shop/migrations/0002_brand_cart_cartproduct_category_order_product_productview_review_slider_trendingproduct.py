    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Pedido recebido', 'Pedido recebido'), ('Processamento de Pedidos', 'Processamento de Pedidos'), ('A caminho', 'A caminho'), ('Pedido concluído', 'Pedido concluído'), ('Pedido cancelado', 'Pedido cancelado')], default='Pedido recebido', max_length=100)),
                ('date', models.DateTimeField(auto_now_add=True)),
